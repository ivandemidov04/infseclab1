...
public final class AuthenticationService {
    ...
    public AuthenticationService(UserService userService, final JwtService jwtService, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager) {
